...
COMMANDS = commands/PRIVMSG.cpp commands/JOIN.cpp commands/TOPIC.cpp commands/INVITE.cpp commands/MODE.cpp commands/KICK.cpp commands/PART.cpp commands/KICK.cpp commands/QUIT.cpp
SRC += $(COMMANDS)
